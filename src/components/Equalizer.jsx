  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={onClose}
          className="text-text-secondary hover:text-text-primary p-1 rounded-full hover:bg-bg-highlight transition"
        >
      ...
      {/* Presets Dropdown */}
      <div className="mb-10">
        <label className="text-[10px] uppercase font-bold text-text-secondary mb-2 block tracking-wider">
          Presets
        </label>
        <select
