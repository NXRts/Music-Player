    ...
    <>
      ...
      >
        <div className="p-6 flex justify-between items-center">
          <h1 className="text-2xl text-text-primary font-bold tracking-tight">
            Music App
          </h1>
          <button
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-28 md:pb-6 scrollbar-hide">
          <div className="flex flex-col gap-4 mb-4">
            ...
            >
              <Heart
                size={24}
                className="bg-gradient-to-br from-indigo-500 to-purple-500 text-white fill-current p-1 rounded-sm"
              />
            ...
            >
              <Activity
                size={24}
                className="bg-gradient-to-br from-orange-500 to-red-500 text-white p-1 rounded-sm"
              />
            ...
            >
              <Library
                size={24}
                className="bg-gradient-to-br from-blue-500 to-cyan-500 text-white p-1 rounded-sm"
              />
          ...
          {playlists.length > 0 && (
            <div className="mt-6 flex flex-col gap-4 mb-8">
              <p className="text-xs uppercase text-text-secondary font-bold mb-2">
                Your Playlists
              </p>
