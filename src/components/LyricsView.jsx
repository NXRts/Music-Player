  ...
  return (
    <div className="h-full w-full flex flex-col bg-bg-card text-white relative">
      ...
      <div className="flex justify-between items-center p-4 bg-bg-card z-10 sticky top-0 border-b border-white/5">
        <span className="font-bold text-sm text-text-secondary uppercase tracking-wider">
          Now Playing
        </span>
        {onClose && (
          <button
      ...
      <div className="flex-1 overflow-y-auto p-4 scrollbar-hide">
        ...
        {/* Song Info */}
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-white hover:underline cursor-pointer leading-tight mb-1">
            {song.title}
          </h2>
          <p className="text-gray-400 font-medium hover:underline cursor-pointer">
            {song.artist}
          </p>
        </div>
